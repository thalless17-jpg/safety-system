[index (7).html](https://github.com/user-attachments/files/28264566/index.7.html)
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
window.addEventListener('load', async () => {
  ...
  if(D.cfg){const b=D.cfg.syncBackend;const invalid=(b==='custom'&&!D.cfg.syncUrl)||(b==='jsonbin'&&!D.cfg.jsonbinId)||(b==='firebase'&&!D.cfg.firebaseUrl)||(b==='sharepoint'&&!D.cfg.spSiteUrl);if(invalid){D.cfg.syncBackend='';try{localStorage.setItem(SK,JSON.stringify(D));}catch(e){}}}
