...
function _mergeRemoteData(remote) {
  ...
  ['employees','locations','users','ppeItems','deliveries','incidents',
   'evaluations','warnings','trainings','purchaseOrders','corrActions',
   'activityLog','deleteRequests','logEntries','autoActions'].forEach(k=>{
